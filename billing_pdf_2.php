...
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
<!-------------------Select Hostpital to preview bill by date range------------------------------------------>
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
...
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
<!-------------------1. หนังสือนำและใบแจ้งหนี้ "ต้นฉบับ"------------------------------------------>
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
<?php require 'includes/opencontainer.php'; ?>
<?php
...
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
<!-------------------1. หนังสือนำและใบแจ้งหนี้ "สำเนา"------------------------------------------->
<!---------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------->
...
//            drawbillingTable(datajson);// last page for reference
    ...
    //-------------------------------------------------------------------------
    //---GROPU3 TABLE Draw-----------------------------------------------------
    //-Template:: \ajax_bypatho_billing\billinngListAll_g3.php-----------------
    //-Ajax File :: ajax_billing/getBillingGroupByCode.php-----------------
    //Get record groupby code by ajax------------------------------------------
    //Then draw table at id drawbill_list_all_page_g3--------------------------
    //-------------------------------------------------------------------------
    error_ajax = "";
    $.ajax({
        'async': false,
