...
//===============================================================
        ...
        "ajax": "data/billing_by_billingdate.php?skey=" + skey + "&start=" + startRange + "&end=" + endRange,
        responsive: true,
        dom: 'BPlfritp',
    ...
    function cbTimerange(starta, enda) {
        ...
        table.ajax.url("data/billing_by_billingdate.php?skey=" + skey + "&start=" + startRange + "&end=" + endRange).load();
