            ...
            "render": function (data, type, row) {
                ...
                if (ugroup_id == '5000' || ugroup_id == '5100') {
                    if (row[10] == "ยังไม่ออกผล") {
                        ...
                        renderdata += '<a href="patient_pdf.php?id=' + row[18] + '&option=F&filetype=zip" class="manage_pdf_' + row[18] + ' btn btn-outline-dark btn-sm me-1 pdf" target="_blank"><i class="fa fa-file-archive"></i>PDF/JPG</a>';
                    }
                }
                else {
                    //show active link

                    renderdata += '<a href="patient_pdf_for_note.php?id=' + row[18] + '" class="manage_pdf_' + row[18] + ' btn btn-outline-primary btn-sm me-1 pdf" target="_blank"><i class="fa fa-pen"></i>ใบจด</a>';
                    renderdata += '<a href="patient_pdf_for_note_v2.php?id=' + row[18] + '&show_item_id=1" class="manage_pdf_' + row[18] + ' btn btn-outline-primary btn-sm me-1 pdf" target="_blank"><i class="fa fa-pen"></i>ใบจดCN</a>';
