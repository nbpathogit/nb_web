        ...
        },
        {
            "render": function (data, type, row) {
                ...
                if (ugroup_id == '5000' || ugroup_id == '5100') {
                    ...
                    renderdata += '<a href="patient_pdf_for_note_v2.php?id=' + row[18] + '&show_item_id=2" class="manage_pdf_' + row[18] + ' btn btn-outline-primary btn-sm me-1 pdf" target="_blank"><i class="fa fa-pen"></i>ใบจดCN</a>';
