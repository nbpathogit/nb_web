...
if ($auth) {
    ...
    if (isset($_REQUEST['end'])) {
        ...
        $bills = ServiceBilling::getAllDateforBillPageByBillingdate($conn, $_REQUEST['start'], $_REQUEST['end']);
        ...
        $bills = ServiceBilling::getAllDateforBillPageByBillingdate($conn, $range);
    }
