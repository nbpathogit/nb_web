...
<div class="container-fluid pt-4 px-4">
    <div class="row bg-nb bg-blue-a rounded align-items-center justify-content-center p-3 mx-1">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <h1>ประวัติการล็อกอินนล็อกเอ้าท์</h1>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#DataTableID').DataTable({
            ...
            "ajax": "data/log_datatable_ajax.php?skey="+skey+"",
            responsive: true,
...

            {
                ...
                buttons: [{
                    ...
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "&range=2m").load();
                ...
                },
                {
                    text: '3 เดือนล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "&range=3m").load();
                ...
                },
                {
                    text: '6 เดือนล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "&range=6m").load();
                ...
                },
                {
                    text: '1 ปีล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "&range=1y").load();
                ...
                },
                {
                    text: '2 ปีล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "&range=2y").load();
                ...
                },
                {
                    text: 'ทั้งหมด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/log_datatable_ajax.php?skey=" + skey + "").load();
