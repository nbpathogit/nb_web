...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#DataTableID').DataTable({
            ...
            "ajax": "data/questionare_cn_slide_ajax.php?skey="+skey+"",
            responsive: true,
...

            {
                ...
                buttons: [{
                    ...
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "&range=2m").load();
                ...
                },
                {
                    text: '3 เดือนล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "&range=3m").load();
                ...
                },
                {
                    text: '6 เดือนล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "&range=6m").load();
                ...
                },
                {
                    text: '1 ปีล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "&range=1y").load();
                ...
                },
                {
                    text: '2 ปีล่าสุด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "&range=2y").load();
                ...
                },
                {
                    text: 'ทั้งหมด',
                    action: function (e, dt, node, config) {
                        dt.ajax.url("data/questionare_cn_slide_ajax.php?skey=" + skey + "").load();
