...
//        fclose($myfile);
    ...
    $patientLists = Patient::getAllJob1FinishPhp($conn, 0, $range,$end);
    ...
    foreach ($patientLists as $patient) {
        if ($patient['pid']) {// exclude id zero
            ...
            $data[] = [$patient['pid'], $patient['p_pnum'], $patient['p_hn'], $patient['p_accept'], 
                ...
                $patient['j_job_role_id'], $patient['j_jobname'], $patient['j_owners'],$patient['p_job1qty'], $patient['j_finish_date'],null];
