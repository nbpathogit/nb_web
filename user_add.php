...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $user_new->short_name = $_POST['short_name'];
    ...
    if (isset($_POST["umobile_enable"])) { //IF checkbox umobile_enable checked
        ...
        $user_new->umobile = $user[0]['umobile'];
        if (!isset($user_new->umobile)) {
            $user_new->umobile = "";
    ...
    if (isset($_POST["uemail_enable"])) { //IF checkbox uemail_enable checked
        ...
        $user_new->uemail = $user[0]['uemail'];
        if (!isset($user_new->uemail)) {
            $user_new->uemail = "";
        } //replace blank instead of NULL
    }
    ...
    if (isset($_POST["username_enable"])) { //IF checkbox username_enable checked
        ...
        $user_new->username = $user[0]['username'];
        $user_new->password = $user[0]['password'];
        $passchg = false;
    }
