...
class TemplateReport
{
    ...
    public static function getTemplateByID($conn, $id) {
        $sql = "SELECT t.id as tid, r.id as rid, r.name as rname, t.name as tname, t.description as tdescription FROM `template_report` as t JOIN report_type as r WHERE t.reporttype_id = r.id";
        if ($id != 0) {
            $sql = $sql . " and t.id = $id";
        }
    ...
    public static function getTemplateNameListByUserByType($conn, $user_id = 0, $type_id = 0) {
