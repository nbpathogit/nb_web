...
<?php
//$hospitals = Hospital::getAll($conn);
//$userPathos = User::getAllbyCytologis($conn);
$userCytologists = User::getAllbyCytologist($conn);
...
Cytologist : <input name="bill_hospitalname" id="bill_hospitalname" size="100"><br>
...
<?php require 'includes/opencontainer.php'; ?>
<?php
$str1 = file_get_contents('ajax_cyto_billing/billingletter1.php');
if (true) {
...
//<?php //require 'includes/opencontainer.php'; ?>
//<?php
//$str1 = file_get_contents('ajax_cyto_billing/billingletterinvoice.php');
//if (false) {
//    $str1 = str_replace("border: 1px solid green;", "border: none;", $str1);
//}
...
<?php require 'includes/opencontainer.php'; ?>
<?php
$str1 = file_get_contents('ajax_cyto_billing/billinngListAll_g2.php');
...
<?php require 'includes/opencontainer.php'; ?>
<?php
$str1 = file_get_contents('ajax_cyto_billing/billinngListAll_g3.php');
...
<script>
    ...
    //    alert(startdate.substr(0, 4) + " " + startdate.substr(5, 2) + " " + startdate.substr(8, 2));
        ...
        $.ajax({
            ...
            type: 'POST',
            'global': false,
            url: 'ajax_cyto_billing/getBillbyCytobyDateRangeSumPrice.php',
            data: {
                'cytologist_id': cytologist_id,
                'startdate': startdate,
                'enddate': enddate,
            },
...
//                    return;
        ...
        $.ajax({
            ...
            type: 'POST',
            'global': false,
            url: 'ajax_cyto_billing/getCostGroupbyServiceTyoebyCytobyDateRange.php',
            data: {
                'cytologist_id': cytologist_id,
                'startdate': startdate,
                'enddate': enddate,
...
//                alert(data);
    ...
    <td><input type="text" style="font-size: 14pt;"  value="' + net_byservice_price[i].bcost_sum + '"></td>\n\
        ...
        $.ajax({
            ...
            type: 'POST',
            'global': false,
            url: 'ajax_cyto_billing/getBillbyCytobyDateRangeGroupBySN.php',
            data: {
                'cytologist_id': cytologist_id,
                'startdate': startdate,
                'enddate': enddate,
...
//                 alert( jqxhr.responseText);
        ...
        $.ajax({
            ...
            type: 'POST',
            'global': false,
            url: 'ajax_cyto_billing/getBillingbyCytoGroupByCode.php',
            data: {
                'cytologist_id': cytologist_id,
                'startdate': startdate,
                'enddate': enddate,
    ...
    //    console.log(result);
        ...
        $.ajax({
            ...
            type: 'POST',
            'global': false,
            url: 'ajax_cyto_billing/getCostSpelling.php',
            data: {
                'cost': cost,
            },
            success: function (data) {
