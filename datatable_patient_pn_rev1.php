...
<?php if ($isCurUserAdmin) : ?>
                            //Botton with link
                            renderdata += '<a href="LINK_PAGE.php?id=' + row[0] + '" class="btn btn-outline-dark btn-sm "><i class="fa-solid fa-people-arrows"></i> SIM</a>';
<?php endif; ?>
                ...
                },
                {
                    "render": function (data, type, row) {
                        //example link page
                        return '<a href="LINK_PAGE.php?id=' + row[0] + '">' + data + '</a>';
                    },
                    "targets": 1
                },
                {
