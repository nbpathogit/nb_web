    ...
    <form id="formflow">
        ...
        <table id="flowtab1" class="flowtab1" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr border="1">
                ...
                <td class="diagram_arrow">&nbsp;</td>
                <td colspan="7"  tabindex="20000" id="keep20000" class="<?= ($curstatus['0']["id"] == 20000 || $patient[0]['reported_as'] == 'ออกผลแล้ว') ? "completed" : 
                                                                            (($curstatus['0']["id"] == 20000 || $patient[0]['reported_as'] == 'ออกผลเบื้องต้น') ? "prelim" : 
                                                                                                                                                                "held" ) ?> state">เสร็จสิ้น<br>20000</td>
