...
<p align="left">
    ...
    <a class="btn btn-outline-primary btn-sm me-1 disabled" data-bs-toggle="modal"  data-bs-target="#add_modal_job3" title="Add" ><i class="fa-sharp fa-solid fa-plus"></i></a>
    <a class="btn btn-outline-primary btn-sm me-1 disabled"  id="refresh_job3" title="Refresh" ><i class="fa-solid fa-rotate-right"></i></a>
