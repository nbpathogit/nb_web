    ...
    <?php foreach ($presultupdates as $presultupdate): ?>
        ...
        <form  id="save_u_result" name="" method="post">
            ...
            <div align=""  class="mb-3">
                ...
                <textarea name="result_message" cols="100" rows="5" class="form-control" id="p_rs_diagnosis" <?= $canEditModePage && $canEditResult_d_group && $canEditResult_d_status && $isUResultNotReleased ? "" : " disabled readonly " ?> ><?= $presultupdate['result_message'] ?></textarea>
            </div>
            ...
            <div class="row <?= $isBorder ? "border" : "" ?>">
                <div class="col-xl-6 col-md-6 <?= $isBorder ? "border" : "" ?> ">
                    ...
                    <select name="pathologist_id" class="form-select" <?= $canEditModePage && $canEditResult_d_group && $canEditResult_d_status && $isUResultNotReleased ? "" : " disabled readonly " ?> >
                ...
                <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
                    ...
                    <input name="date_14000"  type="text" class="form-control border" id="date_14000"  placeholder="This Field will Auto Generate"  <?= $canEditModePage && $canEditResult_d_group && $canEditResult_d_status && $isUResultNotReleased && FALSE ? "" : " disabled readonly " ?> value="<?= $presultupdate['release_time']; ?>">
                    <?php
            ...
            <div class="row  <?= $isBorder ? "border" : "" ?> ">
                <div class=" <?= $isBorder ? "border" : "" ?> ">
                    <?php if ($presultupdate['release_time'] == NULL): //If released not show edit botton ?>
                        ...
                        <?php else: ?>
                            <br><p align="center"><button name="edit_u_result" type="submit" class="btn btn-primary">&nbsp;&nbsp;Edit&nbsp;&nbsp;</button></p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
