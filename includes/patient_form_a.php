...
<div class="row <?= $isBorder ? "border" : "" ?>">
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        ...
        <input name="import_date" class="form-control border" type="text" class="" id="import_date" placeholder="This Field will Auto Generate" <?= $modePageEditDisable || $isDisableEditPatientInfo || TRUE ? " disabled readonly " : "" ?> value="<?= $patient[0]['import_date']; ?>">
    </div>
