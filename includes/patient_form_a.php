...
<div class="row <?= $isBorder ? "border" : "" ?>">
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <input name="pnum" type="text" id="pnum" class="form-control" placeholder=""  <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?>  value="<?= $patient[0]['pnum']; ?>">
    </div>

    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        <label for="plabnum"  align="right" class="">LAB Number</label>
        <input name="plabnum" type="text" class="form-control border" id="plabnum" <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?> value="<?= $patient[0]['plabnum']; ?>">
    </div>
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        ...
        <input name="pname" type="text" class="form-control border" id="pname" placeholder="" <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?> value="<?= $patient[0]['pname']; ?>">
    </div>

    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        <label for="plastname" class="">นามสกุล</label>
        <div class="col">
            <input name="plastname" type="text" class="form-control" id="plastname" placeholder="" <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?> value="<?= $patient[0]['plastname']; ?>">
        </div>
    </div>
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        ...
        <div class="col">
            <input name="pedge" type="text" class="form-control" class="" id="pedge"  placeholder="" <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?> value="<?= $patient[0]['pedge']; ?>">
        </div>
    </div>
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
        <label for="" class="">เลขที่โรงพยาบาล</label>
        <input name="phospital_num" type="text" class="form-control" id=""  placeholder="" <?= $isDisableEditPatientInfo ? " disabled readonly " : "" ?> value="<?= $patient[0]['phospital_num']; ?>" >
    </div>
