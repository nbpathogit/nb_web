...
<div class="row <?= $isBorder ? "border" : "" ?>">
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <select name="p_slide_prep_sp_id" id="p_slide_prep_sp_id"  class="form-select" <?= $isEditModePageOn && ($userAuthEdit) && ($curStatusAuthEdit) ? "" : " disabled readonly " ?> >
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <input name="pspprice" id="pspprice" type="text" class="form-control"   <?= $isEditModePageOn && ($userAuthEdit) && ($curStatusAuthEdit)  ? "" : " disabled readonly " ?>  value="<?= $patient[0]['pspprice']; ?>"  >
    </div>
