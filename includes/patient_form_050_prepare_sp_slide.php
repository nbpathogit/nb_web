...
<div class="row <?= $isBorder ? "border" : "" ?>">
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <select name="p_slide_prep_sp_id" id="p_slide_prep_sp_id"  class="form-select" <?= $canEditModePage && ($isCurUserAdmin || ($canEditPlaning_b_3_group  && $canEditPlaning_b_3_status && $curstatus[0]['id'] == 12000)    )? "" : " disabled readonly " ?> >
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <input name="pspprice" id="pspprice" type="text" class="form-control"   <?= $canEditModePage && ($isCurUserAdmin || ($canEditModePage && $canEditPlaning_b_3_group && $canEditPlaning_b_3_status && $curstatus[0]['id'] == 12000)   )  ? "" : " disabled readonly " ?>  value="<?= $patient[0]['pspprice']; ?>"  >
    </div>
