...
<div class="row <?= $isBorder ? "border" : "" ?>">
    ...
    <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?> ">
        ...
        <input name="p_slide_lab_price" id="p_slide_lab_price" type="text" class="form-control"   <?= $canEditModePage && $canEditPlaning_b_3_group && $canEditPlaning_b_3_status  ? "" : " disabled readonly " ?>  value="<?= $patient[0]['p_slide_lab_price']; ?>"  >
    </div>
