...
//====== GET =======
$tps = TemplateReport::getAllbyid($conn, $_GET['id']);
        ...
        <form method="POST">
            ...
            <div class="row <?= $isBorder ? "border" : "" ?>">
                ...
                <div class="col-xl-4 col-md-6 <?= $isBorder ? "border" : "" ?>">
                    ...
                    <select name="rname_selected" id="rname_selected" class="form-select"  >
                        ...
                        <?php foreach ($rpts as $rpt): ?>
                            ...
                            <option value="<?= htmlspecialchars($rpt['id']); ?>"  <?= $tps[0]['rid'] == $rpt['id'] ? "selected" : ""; ?> >
                                <?= $rpt['name']; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>                                    
                ...
                <div class="col-lg-auto <?= $isBorder ? "border" : "" ?>">
                    ...
                    <input name="tname" type="text" class="form-control border" id="tname" placeholder="" size="100"  value="<?= $tps[0]['tname']; ?>">
                </div>
            ...
            <div class="row <?= $isBorder ? "border" : "" ?>">
                ...
                <textarea name="tdescription" cols="100" rows="5" class="form-control" id="tdescription" ><?= htmlspecialchars($tps[0]['tdescription']); ?> </textarea>
...
//Check box id umobile_enable is checked
    $('#tps_edit_enable').change(function () {
